...
* SP 25 - [Peer2PIR: Private Queries for IPFS.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Peer2PIR%3A+Private+Queries+for+IPFS.&btnG=)
* SP 25 - [Permissionless Verifiable Information Dispersal (Data Availability for Bitcoin Rollups).](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Permissionless+Verifiable+Information+Dispersal+%28Data+Availability+for+Bitcoin+Rollups%29.&btnG=)
* SP 25 - [An Attack on TON’s ADNL Secure Channel Protocol.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=An+Attack+on+TON%E2%80%99s+ADNL+Secure+Channel+Protocol.&btnG=)
* SP 25 - [Decentralization of Ethereum's Builder Market.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Decentralization+of+Ethereum%27s+Builder+Market.&btnG=)
* SP 25 - [Liquefaction: Privately Liquefying Blockchain Assets.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Liquefaction%3A+Privately+Liquefying+Blockchain+Assets.&btnG=)
* SP 25 - [A Composability Analysis Framework for Web3 Wallet Recovery Mechanisms.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=A+Composability+Analysis+Framework+for+Web3+Wallet+Recovery+Mechanisms.&btnG=)
...
* Security 25 - [Auspex: Unveiling Inconsistency Bugs of Transaction Fee Mechanism in Blockchain.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Auspex%3A+Unveiling+Inconsistency+Bugs+of+Transaction+Fee+Mechanism+in+Blockchain.&btnG=)
* Security 25 - [Deanonymizing Ethereum Validators: The P2P Network Has a Privacy Issue.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Deanonymizing+Ethereum+Validators%3A+The+P2P+Network+Has+a+Privacy+Issue.&btnG=)
* Security 25 - [SoK: Understanding zk-SNARKs: The Gap Between Research and Practice.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=SoK%3A+Understanding+zk-SNARKs%3A+The+Gap+Between+Research+and+Practice.&btnG=)
* Security 25 - [Surviving in Dark Forest: Towards Evading the Attacks from Front-Running Bots in Application Layer.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Surviving+in+Dark+Forest%3A+Towards+Evading+the+Attacks+from+Front-Running+Bots+in+Application+Layer.&btnG=)
* Security 25 - [Available Attestation: Towards a Reorg-Resilient Solution for Ethereum Proof-of-Stake.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Available+Attestation%3A+Towards+a+Reorg-Resilient+Solution+for+Ethereum+Proof-of-Stake.&btnG=)
* Security 25 - [Voting-Bloc Entropy: A New Metric for DAO Decentralization.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Voting-Bloc+Entropy%3A+A+New+Metric+for+DAO+Decentralization.&btnG=)
* Security 25 - [Following Devils' Footprint: Towards Real-time Detection of Price Manipulation Attacks.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Following+Devils%27+Footprint%3A+Towards+Real-time+Detection+of+Price+Manipulation+Attacks&btnG=)
* Security 25 - [COLLISIONREPAIR: First-Aid and Automated Patching for Storage Collision Vulnerabilities in Smart Contracts.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=COLLISIONREPAIR%3A+First-Aid+and+Automated+Patching+for+Storage+Collision+Vulnerabilities+in+Smart+Contracts.&btnG=)
* Security 25 - [Let's Move2EVM.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Let%27s+Move2EVM.&btnG=)
* Security 25 - [Does Finality Gadget Finalize Your Block? A Case Study of Binance Consensus](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Does+Finality+Gadget+Finalize+Your+Block%3F+A+Case+Study+of+Binance+Consensus&btnG=)
* Security 25 - [BEAT-MEV: Epochless Approach to Batched Threshold Encryption for MEV Prevention.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=BEAT-MEV%3A+Epochless+Approach+to+Batched+Threshold+Encryption+for+MEV+Prevention.&btnG=)
* Security 25 - [Blockchain Address Poisoning.](https://www.usenix.org/conference/usenixsecurity25/presentation/tsuchiya)
* Security 25 - [Recover from Excessive Faults in Partially-Synchronous BFT SMR](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Recover+from+Excessive+Faults+in+Partially-Synchronous+BFT+SMR&btnG=)
* Security 25 - [Voting-Bloc Entropy: A New Metric for DAO Decentralization.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Voting-Bloc+Entropy%3A+A+New+Metric+for+DAO+Decentralization.&btnG=)
* Security 25 - [Automated Soundness and Completeness Vetting of Polygon.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Automated+Soundness+and+Completeness+Vetting+of+Polygon.&btnG=)
...
* Security 24 - [Guardians of the Galaxy: Content Moderation in the {InterPlanetary} File System](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Guardians+of+the+Galaxy%3A+Content+Moderation+in+the+%7BInterPlanetary%7D+File+System&btnG=)
...
* Security 24 - [SoK: What Don’t We Know? Understanding Security Vulnerabilities in SNARKs.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=SoK%3A+What+Don%E2%80%99t+We+Know%3F+Understanding+Security+Vulnerabilities+in+SNARKs.&btnG=)
* Security 24 - [Using My Functions Should Follow My Checks: Understanding and Detecting Insecure OpenZeppelin Code in Smart Contracts.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Using+My+Functions+Should+Follow+My+Checks%3A+Understanding+and+Detecting+Insecure+OpenZeppelin+Code+in+Smart+Contracts.&btnG=)
* Security 24 - [Practical Security Analysis of Zero-Knowledge Proof Circuits.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Practical+Security+Analysis+of+Zero-Knowledge+Proof+Circuits.&btnG=)
* Security 24 - [GuideEnricher: Protecting the Anonymity of Ethereum Mixing Service Users with Deep Reinforcement Learning.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=GuideEnricher%3A+Protecting+the+Anonymity+of+Ethereum+Mixing+Service+Users+with+Deep+Reinforcement+Learning.&btnG=)
* Security 24 - [Pixel+ and Pixel++: Compact and Efficient Forward-Secure Multi-Signatures for PoS Blockchain Consensus.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Pixel%2B+and+Pixel%2B%2B%3A+Compact+and+Efficient+Forward-Secure+Multi-Signatures+for+PoS+Blockchain+Consensus.&btnG=)
...
* NDSS 25 - [Alba: The Dawn of Scalable Bridges for Blockchains.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Alba%3A+The+Dawn+of+Scalable+Bridges+for+Blockchains.&btnG=)
* NDSS 25 - [Anonymity Schemes Used by Cryptocurrencies.](https://www.ndss-symposium.org/wp-content/uploads/2023/02/ndss2023_s241_paper.pdf)
* NDSS 25 - [Eclipse Attacks on Monero's Peer-to-Peer Network.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Eclipse+Attacks+on+Monero%27s+Peer-to-Peer+Network.&btnG=)
* NDSS 25 - [PropertyGPT: LLM-driven Formal Verification of Smart Contracts through Retrieval-Augmented Property Generation.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=PropertyGPT%3A+LLM-driven+Formal+Verification+of+Smart+Contracts+through+Retrieval-Augmented+Property+Generation.&btnG=)
* NDSS 25 - [MTZK: Testing and Exploring Bugs in Zero-Knowledge (ZK) Compilers.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=MTZK%3A+Testing+and+Exploring+Bugs+in+Zero-Knowledge+%28ZK%29+Compilers.&btnG=)
* NDSS 25 - [Silence False Alarms: Identifying Anti-Reentrancy Patterns on Ethereum to Refine Smart Contract Reentrancy Detection.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Silence+False+Alarms%3A+Identifying+Anti-Reentrancy+Patterns+on+Ethereum+to+Refine+Smart+Contract+Reentrancy+Detection.&btnG=)
* NDSS 25 - [Siniel: Distributed Privacy-Preserving zkSNARK.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Siniel%3A+Distributed+Privacy-Preserving+zkSNARK.&btnG=)
* NDSS 25 - [The Forking Way: When TEEs Meet Consensus.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=The+Forking+Way%3A+When+TEEs+Meet+Consensus.&btnG=)
* NDSS 25 - [Kronos: A Secure and Generic Sharding Blockchain Consensus with Optimized Overhead.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Kronos%3A+A+Secure+and+Generic+Sharding+Blockchain+Consensus+with+Optimized+Overhead.&btnG=)
* NDSS 25 - [Exploring User Perceptions of Security Auditing in the Web3 Ecosystem.](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Exploring+User+Perceptions+of+Security+Auditing+in+the+Web3+Ecosystem.&btnG=)
...
* WWW 24 - [DenseFlow: Spotting Cryptocurrency Money Laundering in Ethereum Transaction Graphs](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=DenseFlow%3A+Spotting+Cryptocurrency+Money+Laundering+in+Ethereum+Transaction+Graphs&btnG=)
...
* FC 14 - [Majority Is Not Enough: Bitcoin Mining Is Vulnerable]()
